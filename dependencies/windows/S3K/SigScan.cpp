...
void* sigScan(const char *signature, const char *mask, void *hint, int hintCount)
{
    const MODULEINFO& moduleInfo = getModuleInfo();
    const size_t length = strlen(mask);
...
SIG_SCAN(SigS3K_SS_Player_Input_Following, "\x40\x53\x48\x83\xEC\x30\x48\x8D\x05\x00\x00\x00\x00\x48\x8B\xD9\x48\x89\x05\x00\x00\x00\x00\x33\xC9\x48\x8B\x05\x00\x00\x00\x00\x48\x8B\x50\x38\xFF\xD2\x48\x8B", "xxxxxxxxx????xxxxxx????xxxxx????xxxxxxxx");
