...
elseif(RETRO_SUBSYSTEM STREQUAL "SDL3")
    pkg_check_modules(SDL3 sdl3 REQUIRED)
    target_link_libraries(RetroEngine ${SDL3_STATIC_LIBRARIES})
    target_link_options(RetroEngine PRIVATE ${SDL3_STATIC_LDLIBS_OTHER})
    target_compile_options(RetroEngine PRIVATE ${SDL3_STATIC_CFLAGS})
endif()

if(NOT RETRO_SUBSYSTEM STREQUAL SDL3)
    if(USE_SDL_AUDIO)
        pkg_check_modules(SDL3 sdl3 REQUIRED)
        target_link_libraries(RetroEngine ${SDL3_STATIC_LIBRARIES})
        target_link_options(RetroEngine PRIVATE ${SDL3_STATIC_LDLIBS_OTHER})
        target_compile_options(RetroEngine PRIVATE ${SDL3_STATIC_CFLAGS})
        target_compile_definitions(RetroEngine PRIVATE RETRO_AUDIODEVICE_SDL3=1)
    endif()
endif()
